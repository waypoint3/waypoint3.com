        ...
        <main>
            ...
            <Container className={"text-sm leading-loose"}>
                ...
                <ul className={"list-disc"}>
                    ...
                    <li>
                        <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Waypoint 3 Ltd, 21 Frensham Avenue, Leeds, LS27 0RP, England.
                    </li>
                    <li>
                ...
                <h2 className={"font-display text-2xl mb-1 mt-2"}>Collecting and Using Your Personal Data</h2>
                ...
                <h3 className={"font-display text-xl"}>Retention of Your Personal Data</h3>
                ...
                <h3 className={"font-display text-xl"}>Transfer of Your Personal Data</h3>
                ...
                <h3 className={"font-display text-xl"}>Delete Your Personal Data</h3>
                ...
                <h3 className={"font-display text-xl"}>Disclosure of Your Personal Data</h3>
                 <h4 className={"font-display text-lg mb-1 mt-2"}>Business Transactions</h4>
                <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                 <h4 className={"font-display text-lg mb-1 mt-2"}>Law enforcement</h4>
                ...
                <h3 className={"font-display text-xl"}>Security of Your Personal Data</h3>
                <p>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
                <h2 className={"font-display text-2xl mb-1 mt-2"}>Children&apos;s Privacy</h2>
                ...
                <h2 className={"font-display text-2xl mb-1 mt-2"}>Changes to this Privacy Policy</h2>
